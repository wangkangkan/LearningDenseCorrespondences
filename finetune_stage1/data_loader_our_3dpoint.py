...
class DataLoader(object):
    ...
    def get_loader_w3d(self):
        ...
        stage2, label = self.read_data(
            fqueue_yes3d)
        # pointset, label, input_pc = self.read_data(
            # fqueue_yes3d)
        ...
        pack_these = [stage2, label]
        pack_name = ['stage2', 'label']
    ...
    def read_data(self, filename_queue):
        with tf.name_scope(None, 'read_data', [filename_queue]):
            ...
            # pointset, label, input_pc = data_utils.parse_example_proto_our_3dpoint(
                # example_serialized, 1723)
