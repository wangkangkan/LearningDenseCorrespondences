...
def get_model(point_cloud, idx_1723_tf=None, is_training=True, bn_decay=None):
    ...
    l1_xyz_f12, l1_points_f12, l1_indices_f12 = pointnet_sa_module_concat(l0_xyz_f1, l0_xyz_f2, points=None, npoint=1723, radius=0.2, nsample=256, mlp=[32,32,64], mlp2=None, group_all=False, pooling='weighted_avg', is_training=is_training, bn_decay=bn_decay, scope='layer1')

    l1_points_f12 = tf.concat([l1_points_f12, l0_xyz_f1], axis=-1)
    l4_points_f1 = decode_model._encode(l1_points_f12)
