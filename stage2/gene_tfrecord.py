...
import numpy as np
import os
from read_depth import sample_from_depth
...
def convert_to_example(frame1, frame2, flow, frm1_point=1723, frm2_point=3000):
...
def proc_one_scene_human(allmodelfiles, output_dir):
    train_or_test = 'train'
    ...
    while i < seqnum:
        ...
        with tf.python_io.TFRecordWriter(tf_filename) as writer:
            ...
            while i < seqnum and j < tnum_shards:
                ...
                frame1 = np.loadtxt('/path/to/stage1/result/sample.txt')
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = "./"
    proc_one_scene_human(allmodelfiles, OUTPUT_DIR)
