...
if __name__ == "__main__":
    ...
    # gt, face = read_obj('./result/gt0.obj')
    # pre1, _ = read_obj('./result/tmodel_0.obj')
    # smpl, _ = read_obj('./result/tmodel_100.obj')
    down_file_name = '0.txt' 
    down = np.loadtxt(down_file_name).astype(np.int)
    idx_1723 = down[:, 1]
    label, _ = read_obj('./test/label.obj')
    label = label[idx_1723]
    np.savetxt('./test/label_1723.txt', label)