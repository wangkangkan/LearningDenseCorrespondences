...
if not osp.exists(model_dir):
    ...
    # import ipdb
    # ipdb.set_trace()
SMPL_MODEL_PATH = osp.join(model_dir, 'basicmodel_m_lbs_10_207_0_v1.0.0.pkl')
SMPL_FACE_PATH = osp.join(curr_path, '../src/tf_smpl', 'smpl_faces.npy')

# Default pred-trained model path for the demo.
#PRETRAINED_MODEL = osp.join(model_dir, 'model.ckpt-5971')#385350
# PRETRAINED_MODEL = './logs/HMR_3DSUP_tran_tfrecords_30w_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_3dsup-weight60_Sep23_1105/model.ckpt-1709638'
...
flags.DEFINE_string('smpl_face_path', SMPL_FACE_PATH,
                    'path to smpl mesh faces (for easy rendering)')#'D:/hmr-master/src/logs/HMR_3DSUP_ourdata_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_3dsup-weight60_Jan01_1055/''D:/hmr-master/src/logs/HMR_3DSUP_ourdata_resnet_fc3_dropout_Elr1e-05_Dlr1e-04_d-weight100_Jan05_0945/'
# flags.DEFINE_string('load_path', None, 'path to trained model')#'E:/hmr-mastercode/src/logs/HMR_3DSUP_ourdata_resnet_fc3_dropout_Elr1e-05_Dlr1e-04_d-weight1000_Feb08_1634'
flags.DEFINE_string('load_path', None, 'path to trained model')#'E:/hmr-mastercode/src/logs/HMR_3DSUP_ourdata_resnet_fc3_dropout_Elr1e-05_Dlr1e-04_d-weight1000_Feb08_1634'
flags.DEFINE_string('pretrained_model_path', './logs/HMR_3DSUP_tran_cape_20w_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_d-weight0.001_3dsup-weight60_May15_1447/model.ckpt-344601',#'D:/hmr-master/src/models/resnet_v2_50.ckpt'
                    'if not None, fine-tunes from this ckpt')
flags.DEFINE_integer('batch_size', 1,
                     'Input image size to the network after preprocessing')

# Don't change if testing:
flags.DEFINE_integer('img_size', 512,
                     'Input image size to the network after preprocessing')
...
DATA_DIR = '/test/tf_datasets/'#''/scratch1/projects/tf_datasets/'
...
flags.DEFINE_string('model_dir', './logs/HMR_3DSUP_tran_cape_20w_resnet_fc3_dropout_Elr1e-05_kp-weight60_Dlr1e-04_d-weight100_3dsup-weight60_Apr29_0903/model.ckpt-41978', 'Where model will be saved -- filled automatically')
flags.DEFINE_integer('log_img_step', 1000, 'How often to visualize img during training')
flags.DEFINE_integer('epoch', 100000, '# of epochs to train')
#, 'coco', 'lsp_ext', 'mpii','h36m','lsp', 'mpi_inf_3dhp'
flags.DEFINE_list('datasets', ['tran_cape_20w'],
...
flags.DEFINE_float('d_loss_weight', 0.1, 'weight on discriminator')


flags.DEFINE_float('e_3d_weight', 60, 'weight on E_3d')#60,1000
...
flags.DEFINE_integer('pointNet_pointnum', 2500, 'point number of each example in PointNet')#8192
